...
pygame.display.set_caption('Target logo') 
...
#Load the image
targetorg=pygame.image.load('targetLogo.jpg').convert()
#Assign the location of the image
screen.blit(targetorg,(400,35))
#Assign the font for target text under logo
targetFont=pygame.font.SysFont("Franklin Gothic Demi",40)
#Assign the set the coordenates for the text under the logo and the colour
targettext=targetFont.render("TARGET",True,(217,27,53))
screen.blit(targettext,(50,240))
